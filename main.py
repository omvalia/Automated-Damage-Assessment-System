...
# and summarizing the entire video, providing the important points for claiming insurance.
# The summary must cover the following points:
# Here's a common template for summarizing Car, Home Renovation, and Medical Insurance Claims. This template is designed to ensure that essential details unique to each type of claim are captured while maintaining a consistent structure:
# Insurance Claim Summary
# Claim Number: [CLAIM_NUMBER]
# Policyholder Name: [POLICYHOLDER_NAME]
# Policy Number: [POLICY_NUMBER]
...
# if anything is not provided just say the 'Not provided'
# Stick to the provided format of summary
# Provide each detail in a new line
# Please provide the summary of the text given here: """
...
st.title("Video to Detailed Notes Converter")
